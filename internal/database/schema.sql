...
CREATE TABLE IF NOT EXISTS exams (
    ...
    questions JSONB NOT NULL, -- Snapshot das questões no momento da criação (imutável para manter histórico)
...
-- ============================================
-- Relacionamento many-to-many normalizado entre exames e matérias
